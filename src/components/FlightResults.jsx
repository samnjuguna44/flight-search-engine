...
const FlightResults = ({ flights, isLoading }) => {
  ...
  const getBestDealIndex = () => {
    ...
    return flights.reduce(
      (bestIdx, flight, idx, arr) =>
        parseFloat(flight.price.total) < parseFloat(arr[bestIdx].price.total)
          ? idx
          : bestIdx,
      0
    );
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t-2 border-gray-100">
              ...
              <button
                ...
                className="w-full sm:w-auto group relative bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-105"
              >
